...
//      body: new Text("${widget.value}"),
      body: Column(
        ...
        children: <Widget>[
          ...
          Expanded(child: Container( child: getRank(),)),
          Expanded(
            flex: 0,
            child: Container(
              child: Container(
  ...
  Widget SliverStandard() {
    ...
    return GridView.builder(
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),
      itemCount: datassta.length,
      itemBuilder: (context, index) {
        final item = datassta[index];
  ...
  Widget SliverModerate() {
    ...
    return GridView.builder(
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),
      itemCount: datasmod.length,
      itemBuilder: (context, index) {
        final item = datasmod[index];
  ...
  Widget SliverPremium() {
    return GridView.builder(
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),
      itemCount: dataspre.length,
      itemBuilder: (context, index) {
        final item = dataspre[index];
