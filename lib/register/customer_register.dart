...
import 'package:bujishu1/Tutorial/main_pdf.dart';
...
void main() => runApp(customerregister());
...
//        });
  ...
  final informationNext = Material(
//      elevation: 5.0,
    borderRadius: BorderRadius.circular(5.0),
  ...
  Widget build(BuildContext context) {
    ...
    final agreement = Material(
      ...
      child: MaterialButton(
        ...
        child: Text("Agreement", textAlign: TextAlign.center),
      ),
    );
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          ...
                          padding:
                              EdgeInsets.fromLTRB(127.0, 12.0, 127.0, 12.0),
                          child: Text(
                            'Registration',
                            textAlign: TextAlign.center,
                            style: new TextStyle(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Padding(
                padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
                child: Text('Residential Address Line 1'),
              ),
            ),
            Container(
                margin: EdgeInsets.only(top: 10),
            ...
            Container(
              ...
              child: Padding(
                padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
                child: Text('Residential Address Line 2'),
              ),
            ),
            Container(
                margin: EdgeInsets.only(top: 10),
            ...
            Container(
              ...
              child: Padding(
                padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
                child: Text('Residential Address Line 3'),
              ),
            ),
            Container(
                margin: EdgeInsets.only(top: 10),
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    validator: (value) {
                      if (value.isEmpty) {
                        return 'Please enter your Address 3';
                      }
                      return null;
                    },
                    decoration: InputDecoration(
...
//                                                width: 200,
                    child: InkWell(
                        child: Text('click here to see agreement'),
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>
                                    PdfViewPage(path: assetPDFPath))))
                    //filePath: 'assets/PDFs/bujishu_agreement.pdf',
                    ),
              ],
            ),
            Container(
